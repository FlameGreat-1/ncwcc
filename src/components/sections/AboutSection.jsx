  ...
  return (
    <section ref={sectionRef} className="section-padding bg-white relative overflow-hidden" id="about">
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-[#00FF66]/2 to-[#00cc52]/2 rounded-full blur-3xl animate-spin-slow"></div>
      </div>
      ...
      <div className="container mx-auto relative z-10">
        ...
        <h2 className="text-3xl md:text-4xl font-black text-black mb-12 animate-fade-in-up">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 mb-16 border-2 border-white/40 shadow-2xl hover:shadow-[0_0_60px_rgba(0,255,102,0.15)] transition-all duration-700 group overflow-hidden animate-fade-in-up delay-300">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="absolute -inset-1 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] rounded-2xl blur opacity-0 group-hover/feature:opacity-30 transition-all duration-700"></div>
                    <div className={`relative flex items-center p-6 rounded-2xl transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden ${
                      feature.highlight 
                        ? 'bg-gradient-to-br from-[#00FF66]/10 via-white/90 to-[#00cc52]/10 border-2 border-[#00FF66]/30 shadow-lg' 
                        : 'bg-white/90 backdrop-blur-lg border-2 border-white/40 shadow-lg hover:shadow-2xl'
                    }`}>
                      <div className="absolute inset-0 bg-gradient-to-br from-[#00FF66]/5 via-transparent to-[#00cc52]/5 opacity-0 group-hover/feature:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#00FF66] to-transparent transform scale-x-0 group-hover/feature:scale-x-100 transition-transform duration-700"></div>
                      <div className="absolute -top-2 -right-2 w-4 h-4 bg-[#00FF66] rounded-full opacity-0 group-hover/feature:opacity-100 animate-ping transition-opacity duration-700"></div>
                      ...
                      <span className={`relative font-bold text-sm ${
                        feature.highlight ? 'text-[#00cc52]' : 'text-gray-800 group-hover/feature:text-[#00FF66]'
                      } transition-colors duration-500`}>
                        {feature.text}
                      </span>
                      
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#00FF66] to-[#00cc52] transform scale-x-0 group-hover/feature:scale-x-100 transition-transform duration-700 rounded-b-2xl"></div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-1000">
            <div className="relative group">
              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 border-2 border-white/40 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-4xl font-black text-[#00FF66] group-hover:text-black mb-3 transition-all duration-500 group-hover:scale-110 group-hover:animate-pulse">
                    {happyCustomers}+
                  </div>
                  <p className="text-[#666] font-bold group-hover:text-[#00FF66] transition-colors duration-500 text-sm">Happy Customers</p>
                </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 border-2 border-white/40 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#666] font-bold group-hover:text-[#00FF66] transition-colors duration-500 text-sm">Bond-Back Guarantee</p>
                </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 border-2 border-white/40 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className={`text-4xl font-black text-[#00FF66] group-hover:text-black mb-3 transition-all duration-1000 group-hover:scale-110 ${isVisible ? 'animate-bounce-in' : 'opacity-0 translate-y-10'}`}>
                    24/7
                  </div>
                  <p className="text-[#666] font-bold group-hover:text-[#00FF66] transition-colors duration-500 text-sm">Customer Support</p>
                </div>
