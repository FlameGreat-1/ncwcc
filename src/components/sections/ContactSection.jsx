        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div ref={contactInfoRef} className="space-y-10">
            <div className="relative group animate-fade-in-up" style={{ animationDelay: `${contactInfoVisible ? 400 : 0}ms` }}>
              ...
              <div className="relative bg-white/90 backdrop-blur-xl border-2 border-white/40 rounded-3xl p-8 shadow-2xl hover:shadow-[0_0_60px_rgba(0,109,166,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-2xl font-black text-gray-900 mb-8 group-hover:text-[#006da6] transition-colors duration-500">Contact Information</h3>
                  ...
                  <div className="space-y-8">
                    <div className="relative group/contact-item">
                      ...
                      <div className="relative flex items-start space-x-6 bg-white/80 backdrop-blur-lg border border-white/40 rounded-2xl p-6 hover:bg-white/90 transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl">
                        <div className="relative group/icon">
                          ...
                          <div className="relative w-16 h-16 bg-gradient-to-br from-[#006da6]/20 via-white/80 to-[#005a8a]/20 backdrop-blur-xl border-2 border-[#006da6]/30 rounded-2xl flex items-center justify-center flex-shrink-0 hover:border-[#006da6]/50 transition-all duration-500 hover:scale-110 hover:rotate-12 transform-gpu shadow-lg hover:shadow-2xl overflow-hidden"
                               style={{ transformStyle: 'preserve-3d' }}>
                            <div className="absolute inset-0 bg-gradient-to-br from-[#006da6]/10 via-transparent to-[#005a8a]/10 opacity-0 group-hover/icon:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                            <span className="relative z-10 text-[#006da6] text-2xl group-hover/icon:animate-bounce">📞</span>
                        ...
                        <div className="flex-1">
                          <h4 className="font-black text-gray-900 mb-2 group-hover/contact-item:text-[#006da6] transition-colors duration-500">Phone</h4>
                      ...
                      <div className="relative flex items-start space-x-6 bg-white/80 backdrop-blur-lg border border-white/40 rounded-2xl p-6 hover:bg-white/90 transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl">
                        <div className="relative group/icon">
                          ...
                          <div className="relative w-16 h-16 bg-gradient-to-br from-[#006da6]/20 via-white/80 to-[#005a8a]/20 backdrop-blur-xl border-2 border-[#006da6]/30 rounded-2xl flex items-center justify-center flex-shrink-0 hover:border-[#006da6]/50 transition-all duration-500 hover:scale-110 hover:rotate-12 transform-gpu shadow-lg hover:shadow-2xl overflow-hidden"
                               style={{ transformStyle: 'preserve-3d' }}>
                            <div className="absolute inset-0 bg-gradient-to-br from-[#006da6]/10 via-transparent to-[#005a8a]/10 opacity-0 group-hover/icon:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                            <span className="relative z-10 text-[#006da6] text-2xl group-hover/icon:animate-bounce">✉️</span>
                            <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#006da6] rounded-full opacity-0 group-hover/icon:opacity-100 animate-ping transition-opacity duration-700"></div>
                          </div>
                        </div>
                        <div className="flex-1">
                          <h4 className="font-black text-gray-900 mb-2 group-hover/contact-item:text-[#006da6] transition-colors duration-500">Email</h4>
                          <div className="space-y-3">
                            <div className="relative group/email">
                              <p className="text-gray-600 text-sm font-medium mb-1">General Support:</p>
                              <button
                                onClick={handleEmailSupport}
                                className="relative text-[#006da6] hover:text-white font-black transition-all duration-500 hover:scale-105 inline-block transform-gpu"
                              >
                    ...
                    <div className="relative group/contact-item">
                      ...
                      <div className="relative flex items-start space-x-6 bg-white/80 backdrop-blur-lg border border-white/40 rounded-2xl p-6 hover:bg-white/90 transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl">
                        ...
                        <div className="flex-1">
                          <h4 className="font-black text-gray-900 mb-2 group-hover/contact-item:text-[#006da6] transition-colors duration-500">Business Details</h4>
            ...
            <div className="relative group animate-fade-in-up" style={{ animationDelay: `${contactInfoVisible ? 600 : 0}ms` }}>
              ...
              <div className="relative bg-white/90 backdrop-blur-xl border-2 border-white/40 rounded-3xl p-8 shadow-2xl hover:shadow-[0_0_60px_rgba(0,109,166,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-black text-gray-900 mb-6 group-hover:text-[#006da6] transition-colors duration-500">Business Hours</h3>
                      ...
                      <div className="space-y-4">
                        {businessHoursArray.map(({ day, hours }) => (
                          <div key={day} className="relative group/day flex justify-between items-center">
                            ...
                            <span className="relative font-black text-gray-900 group-hover/day:text-[#006da6] transition-colors duration-500">{day}</span>
            ...
            <div className="relative group animate-fade-in-up" style={{ animationDelay: `${contactInfoVisible ? 800 : 0}ms` }}>
              ...
              <div className="relative bg-white/90 backdrop-blur-xl border-2 border-white/40 rounded-3xl p-8 shadow-2xl hover:shadow-[0_0_60px_rgba(0,109,166,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-black text-gray-900 mb-6 group-hover:text-[#006da6] transition-colors duration-500">Service Areas</h3>
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {SERVICE_AREAS.map((area, index) => (
                      <div key={index} className="relative group/area">
                        ...
                        <div className="relative bg-white/80 backdrop-blur-lg border border-white/40 rounded-2xl p-4 hover:bg-white/90 transition-all duration-500 hover:scale-105 transform-gpu shadow-lg hover:shadow-xl">
                          <div className="flex items-center space-x-3">
                            <div className="relative group/area-icon">
                              ...
                              <div className="relative w-10 h-10 bg-gradient-to-br from-[#006da6]/20 via-white/80 to-[#005a8a]/20 backdrop-blur-xl border-2 border-[#006da6]/30 rounded-xl flex items-center justify-center flex-shrink-0 hover:border-[#006da6]/50 transition-all duration-500 hover:scale-110 hover:rotate-12 transform-gpu shadow-lg hover:shadow-xl overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#006da6]/10 via-transparent to-[#005a8a]/10 opacity-0 group-hover/area-icon:opacity-100 transition-opacity duration-700 rounded-xl"></div>
                                <span className="relative z-10 text-[#006da6] text-sm group-hover/area-icon:animate-bounce">📍</span>
                              </div>
                            </div>
                            <span className="font-black text-gray-900 text-sm group-hover/area:text-[#006da6] transition-colors duration-500">{area}</span>
                          </div>
                        </div>
                      </div>
                    ))}
          ...
          <div ref={formRef} className="relative group animate-fade-in-up" style={{ animationDelay: `${formVisible ? 400 : 0}ms` }}>
            ...
            <div className="relative bg-white/90 backdrop-blur-xl border-2 border-white/40 rounded-3xl p-8 shadow-2xl hover:shadow-[0_0_60px_rgba(0,109,166,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-black text-gray-900 mb-8 group-hover:text-[#006da6] transition-colors duration-500">Send us a Message</h3>
        ...
        {showMap && (
          <div className="relative group animate-fade-in-up">
            ...
            <div className="relative bg-white/90 backdrop-blur-xl border-2 border-white/40 rounded-3xl p-8 shadow-2xl hover:shadow-[0_0_60px_rgba(0,109,166,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-black text-gray-900 mb-6 group-hover:text-[#006da6] transition-colors duration-500">Our Service Areas</h3>
                <div className="relative group/map-container">
                  ...
                  <div className="relative bg-gray-100 rounded-2xl h-96 flex items-center justify-center border-2 border-[#006da6]/20 hover:border-[#006da6]/40 transition-all duration-500">
                    <div className="text-center">
                      <div className="relative group/map-icon mb-4">
                        ...
                        <div className="relative w-20 h-20 bg-gradient-to-br from-[#006da6]/20 via-white/80 to-[#005a8a]/20 backdrop-blur-xl border-2 border-[#006da6]/30 rounded-full flex items-center justify-center mx-auto hover:border-[#006da6]/50 transition-all duration-500 hover:scale-110 hover:rotate-12 transform-gpu shadow-lg hover:shadow-2xl overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-br from-[#006da6]/10 via-transparent to-[#005a8a]/10 opacity-0 group-hover/map-icon:opacity-100 transition-opacity duration-700 rounded-full"></div>
                          <span className="relative z-10 text-[#006da6] text-3xl group-hover/map-icon:animate-bounce">🗺️</span>
                        </div>
                      </div>
                      <p className="text-gray-600 font-medium">Interactive map coming soon!</p>
                      <p className="text-sm text-gray-500 mt-2">We service all areas listed above</p>
                    </div>
                  </div>
                </div>
              </div>
