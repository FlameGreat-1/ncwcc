          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center mb-16">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-black mb-8 animate-fade-in-up leading-tight">
                Our Professional <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Cleaning Services</span>
              </h1>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-black text-black mb-8 animate-fade-in-up">
                  Detailed Service <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Information</span>
                </h2>
              ...
              <div className="space-y-12">
                {mainServices.map((service, index) => (
                  ...
                  >
                    ...
                    <div className="relative bg-gradient-to-br from-gray-50/80 via-white/90 to-gray-50/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border-2 border-white/40 shadow-2xl hover:shadow-[0_0_60px_rgba(0,255,102,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                      ...
                      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2">
                          <div className="flex items-center gap-4 mb-6">
                            <h3 className="text-2xl md:text-3xl font-black text-gray-900 group-hover:text-[#00FF66] transition-colors duration-500">
                              {service.title}
                            </h3>
                            {service.popular && (
                              <span className="bg-gradient-to-r from-[#00FF66] to-[#00cc52] text-black text-sm font-black px-3 py-1 rounded-full shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110">
                                Most Popular
                              </span>
                            )}
                          ...
                          <div className="mb-8">
                            <h4 className="text-xl font-black text-gray-900 mb-4 group-hover:text-[#00FF66] transition-colors duration-500">What's Included:</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {service.includes.map((item, itemIndex) => (
                                <div key={itemIndex} className="flex items-start group/item">
                                  ...
                                  <span className="text-[#4B4B4B] font-medium group-hover/item:text-[#00FF66] transition-colors duration-300">{item}</span>
                                </div>
                              ))}
                            </div>
                          </div>
                          ...
                          {service.guarantee && (
                            <div className="bg-gradient-to-r from-[#00FF66]/10 via-white/50 to-[#00cc52]/10 backdrop-blur-lg border-2 border-[#00FF66]/30 rounded-2xl p-4 mb-6 group-hover:border-[#00FF66]/50 transition-all duration-500">
                              <h4 className="font-black text-[#00cc52] mb-2 group-hover:text-black transition-colors duration-500">Our Guarantee</h4>
                              <p className="text-[#00cc52] font-medium group-hover:text-black transition-colors duration-500">{service.guarantee}</p>
                            </div>
                          )}
                        </div>
                          ...
                          <div className="relative bg-white/90 backdrop-blur-xl rounded-2xl p-6 shadow-xl border-2 border-white/40 hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu h-fit overflow-hidden">
                            ...
                            <div className="relative z-10">
                              <div className="text-center mb-6">
                                <div className="text-3xl font-black text-[#00FF66] group-hover/card:text-black mb-2 transition-colors duration-500">
          ...
          <section ref={addonsRef} className="section-padding bg-gradient-to-br from-gray-50/80 via-white/60 to-gray-50/80 backdrop-blur-xl relative z-10">
            <div className="container mx-auto">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  <h2 className="text-3xl md:text-4xl font-black text-black mb-8 animate-fade-in-up">
                    Additional <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Services</span>
                  </h2>
                  <p className="text-base text-[#4B4B4B] max-w-2xl mx-auto font-medium animate-fade-in-up delay-300">
                      ...
                      <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 transform-gpu border-2 border-white/40 overflow-hidden h-full flex flex-col">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-black text-gray-900 group-hover:text-[#00FF66] transition-colors duration-500">{service.title}</h3>
                            <div className="text-right">
                              <div className="text-2xl font-black text-[#00FF66] group-hover:text-black transition-colors duration-500">
                                {formatCurrency(service.basePrice)}
                              </div>
                          ...
                          <div className="mb-6 flex-grow">
                            <h4 className="font-black text-gray-900 mb-3 group-hover:text-[#00FF66] transition-colors duration-500">Includes:</h4>
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto">
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] rounded-3xl blur opacity-0 group-hover:opacity-30 transition-all duration-700"></div>
                <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 text-center shadow-2xl border-2 border-white/40 hover:shadow-[0_0_60px_rgba(0,255,102,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#00FF66]/5 via-transparent to-[#00cc52]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl"></div>
                  <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 rounded-t-3xl"></div>
                  ...
                  <div className="relative z-10">
                    <h2 className="text-3xl md:text-4xl font-black text-black mb-8 group-hover:text-[#00FF66] transition-colors duration-500 animate-fade-in-up">
                      Need a Custom <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Cleaning Solution?</span>
                    </h2>
                    <p className="text-base text-[#4B4B4B] mb-12 max-w-2xl mx-auto font-medium group-hover:text-[#333] transition-colors duration-500 animate-fade-in-up delay-300">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up delay-600">
                      ...
                      <Button
                        ...
                        className="relative bg-transparent border-2 border-[#00FF66] text-[#00FF66] hover:bg-gradient-to-r hover:from-black hover:to-gray-800 hover:text-white hover:border-black font-black px-6 py-3 rounded-full text-sm transition-all duration-700 hover:scale-110 hover:-translate-y-2 hover:-rotate-1 shadow-xl hover:shadow-[0_15px_30px_rgba(0,0,0,0.2)] transform-gpu group/cta overflow-hidden"
                        style={{ transformStyle: 'preserve-3d' }}
                      >
                        <span className="relative z-10 flex items-center gap-2">
                          <span className="text-lg group-hover/cta:animate-pulse">💬</span>
                          Discuss Requirements
                        </span>
                        <div className="absolute inset-0 bg-gradient-to-r from-[#00FF66]/10 to-[#00cc52]/10 opacity-0 group-hover/cta:opacity-100 transition-opacity duration-700 rounded-full"></div>
                      </Button>
                    </div>
                  </div>
