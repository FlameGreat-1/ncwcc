...
const FAQ = () => {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      'Pricing': 'from-[#00FF66] to-[#00cc52] text-black',
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center mb-20">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-black mb-8 animate-fade-in-up leading-tight">
                Frequently Asked <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Questions</span>
              </h1>
              ...
              <div className="relative group animate-fade-in-up delay-500">
                ...
                <div className="relative bg-gradient-to-r from-[#00FF66]/10 via-white/80 to-[#00cc52]/10 backdrop-blur-xl border-2 border-[#00FF66]/30 rounded-3xl p-6 inline-block hover:border-[#00FF66]/50 transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu shadow-xl hover:shadow-2xl overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <p className="text-sm text-gray-700 font-medium group-hover:text-gray-900 transition-colors duration-500">
                      <span className="font-black text-[#00cc52] text-lg group-hover:text-black transition-colors duration-500">{totalFAQs} questions</span> answered to help you make informed decisions
                    </p>
                  </div>
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#00FF66] rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-700"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="relative group animate-fade-in-up">
                <div className="absolute -inset-2 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] rounded-3xl blur opacity-0 group-hover:opacity-30 transition-all duration-700"></div>
                <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border-2 border-white/40 hover:shadow-[0_0_60px_rgba(0,255,102,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu mb-16 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#00FF66]/5 via-transparent to-[#00cc52]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl"></div>
                  ...
                  <div className="relative z-10">
                    <div className="flex flex-col md:flex-row gap-6 mb-8">
                      <div className="flex-1 relative group/search">
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#00FF66] to-[#00cc52] rounded-2xl blur opacity-0 group-hover/search:opacity-30 transition-all duration-500"></div>
                        <input
                          type="text"
                          placeholder="Search questions..."
                          value={searchTerm}
                          onChange={(e) => setSearchTerm(e.target.value)}
                          className="relative w-full px-6 py-4 border-2 border-[#00FF66]/30 rounded-2xl focus:outline-none focus:border-[#00FF66] focus:ring-4 focus:ring-[#00FF66]/20 transition-all duration-500 bg-white/90 backdrop-blur-lg shadow-lg focus:shadow-2xl font-medium text-gray-900 placeholder-gray-500 hover:border-[#00FF66]/50 hover:shadow-xl group-hover/search:scale-105 transform-gpu"
                        />
                        <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                          <div className="w-6 h-6 text-[#00FF66] group-hover/search:animate-pulse">
                      ...
                      <div className="relative group/select">
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#00FF66] to-[#00cc52] rounded-2xl blur opacity-0 group-hover/select:opacity-30 transition-all duration-500"></div>
                        <select
                          value={selectedCategory}
                          onChange={(e) => setSelectedCategory(e.target.value)}
                          className="relative px-6 py-4 border-2 border-[#00FF66]/30 rounded-2xl focus:outline-none focus:border-[#00FF66] focus:ring-4 focus:ring-[#00FF66]/20 transition-all duration-500 bg-white/90 backdrop-blur-lg shadow-lg focus:shadow-2xl font-medium text-gray-900 hover:border-[#00FF66]/50 hover:shadow-xl group-hover/select:scale-105 transform-gpu min-w-[200px]"
                        >
                    ...
                    {(searchTerm || selectedCategory !== 'all') && (
                      <div className="flex items-center justify-between bg-gradient-to-r from-[#00FF66]/10 via-white/50 to-[#00cc52]/10 backdrop-blur-lg border border-[#00FF66]/20 rounded-2xl p-4">
                        <p className="text-sm text-gray-600 font-medium">
                          Showing <span className="font-black text-[#00FF66]">{filteredFAQs.length}</span> of <span className="font-black">{totalFAQs}</span> questions
                          {searchTerm && <span className="text-gray-800"> for "<span className="font-black text-[#00cc52]">{searchTerm}</span>"</span>}
                          {selectedCategory !== 'all' && <span className="text-gray-800"> in <span className="font-black text-[#00cc52]">{selectedCategory}</span></span>}
                        </p>
                        <button
                          onClick={handleClearSearch}
                          className="relative group/clear text-sm text-[#00FF66] hover:text-white font-black px-4 py-2 rounded-xl bg-transparent hover:bg-gradient-to-r hover:from-[#00FF66] hover:to-[#00cc52] transition-all duration-500 hover:scale-110 hover:-translate-y-1 transform-gpu shadow-lg hover:shadow-2xl overflow-hidden"
                        >
                          <span className="relative z-10">Clear filters</span>
                          <div className="absolute inset-0 bg-gradient-to-r from-[#00FF66]/10 to-[#00cc52]/10 opacity-0 group-hover/clear:opacity-100 transition-opacity duration-500 rounded-xl"></div>
                        </button>
                      </div>
                    )}
                  </div>
              ...
              {filteredFAQs.length === 0 ? (
                <div className="relative group animate-fade-in-up delay-300">
                  <div className="absolute -inset-2 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] rounded-3xl blur opacity-0 group-hover:opacity-30 transition-all duration-700"></div>
                  <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-16 text-center shadow-2xl border-2 border-white/40 hover:shadow-[0_0_60px_rgba(0,255,102,0.15)] transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#00FF66]/5 via-transparent to-[#00cc52]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl"></div>
                    <div className="relative z-10">
                      <div className="text-8xl mb-8 animate-bounce">🔍</div>
                      <h3 className="text-2xl font-black text-gray-900 mb-6 group-hover:text-[#00FF66] transition-colors duration-500">No questions found</h3>
                  ...
                  {filteredFAQs.map((faq, index) => (
                    ...
                    >
                      ...
                      <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu border-2 border-white/40 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#00FF66]/5 via-transparent to-[#00cc52]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl"></div>
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 rounded-t-3xl"></div>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              <h3 className="text-lg md:text-xl font-black text-gray-900 pr-4 group-hover/button:text-[#00FF66] transition-colors duration-500 leading-tight">
                                {faq.question}
                              </h3>
                            </div>
                            <div className="relative group/arrow">
                              <div className="absolute -inset-2 bg-gradient-to-r from-[#00FF66] to-[#00cc52] rounded-full blur opacity-0 group-hover/arrow:opacity-40 transition-all duration-500"></div>
                              <div className={`relative w-12 h-12 bg-white/80 backdrop-blur-lg border-2 border-[#00FF66]/30 rounded-full flex items-center justify-center transition-all duration-500 hover:bg-gradient-to-r hover:from-[#00FF66] hover:to-[#00cc52] hover:border-[#00FF66] hover:scale-110 transform-gpu shadow-lg hover:shadow-xl ${
                                openItems.has(faq.id) ? 'rotate-180 bg-gradient-to-r from-[#00FF66] to-[#00cc52] border-[#00FF66]' : ''
                              }`}>
                          ...
                          <div className="relative z-10 px-8 pb-8 animate-fade-in-up">
                            <div className="border-t border-[#00FF66]/20 pt-6">
                              <div className="relative group/answer">
                                <div className="absolute -inset-2 bg-gradient-to-r from-[#00FF66]/10 to-transparent opacity-0 group-hover/answer:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] rounded-3xl blur opacity-0 group-hover:opacity-30 transition-all duration-700"></div>
                <div className="relative bg-gradient-to-r from-[#00FF66]/10 via-white/80 to-blue-50/80 backdrop-blur-xl rounded-3xl p-8 md:p-16 text-center shadow-2xl border-2 border-[#00FF66]/30 hover:border-[#00FF66]/50 transition-all duration-700 hover:-translate-y-2 hover:scale-105 transform-gpu overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-[#00FF66]/20 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity duration-700"></div>
                      </Button>
                    </div>
                  </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-black text-black mb-8 animate-fade-in-up">
                  Quick Help <span className="bg-gradient-to-r from-[#00FF66] via-[#00e65a] to-[#00cc52] bg-clip-text text-transparent">Topics</span>
                </h2>
              </div>
                  ...
                  <div key={index} className="relative group animate-fade-in-up" style={{ animationDelay: `${400 + index * 200}ms` }}>
                    ...
                    <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 hover:scale-105 transform-gpu border-2 border-white/40 text-center overflow-hidden h-full flex flex-col">
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        ...
                        <h3 className="text-xl font-black text-gray-900 mb-4 group-hover:text-[#00FF66] transition-colors duration-500">{topic.title}</h3>
                        ...
                        <button
                          ...
                          className="relative text-[#00FF66] hover:text-white font-black text-sm bg-transparent hover:bg-gradient-to-r hover:from-[#00FF66] hover:to-[#00cc52] px-6 py-3 rounded-2xl border-2 border-[#00FF66] hover:border-[#00FF66] transition-all duration-500 hover:scale-110 hover:-translate-y-1 transform-gpu shadow-lg hover:shadow-2xl group/btn overflow-hidden mt-auto"
                        >
                          <span className="relative z-10">View {topic.title.split(' ')[0]} FAQs</span>
                          <div className="absolute inset-0 bg-gradient-to-r from-[#00FF66]/10 to-[#00cc52]/10 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                        </button>
                      </div>
